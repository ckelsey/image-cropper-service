...
function draw360(sourceUrl, destinationUrl, options) {
	return new Promise((resolve, reject) => {
		...
		var lat = options.tilt ? sanitizer.number(options.tilt[0]) : -5
		...
		var w = options.width ? sanitizer.number(options.width[0]) : 4096
		var h = options.height ? sanitizer.number(options.height[0]) : 2048
